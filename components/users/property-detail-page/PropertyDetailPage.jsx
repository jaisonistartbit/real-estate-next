...
export default function PropertyDetailPage({ property }) {
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            setUploadingFileFetch('Loading Property')
    ...
    return (
        <div className="bg-white">
            {
                (uploadingFileFetch) ?
                    <div className="flex  justify-center items-center  my-12   bg-white dark:bg-gray-900">
                        <div className="text-center">
                            <svg className="animate-spin h-15 w-15 text-brand-500 mx-auto" viewBox="0 0 24 24">
